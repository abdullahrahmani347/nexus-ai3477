...
export const IntegratedSidebar: React.FC<IntegratedSidebarProps> = ({ isOpen, onClose }) => {
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 lg:relative lg:inset-auto lg:z-auto">
        ...
        <div className="fixed left-0 top-0 h-full w-80 max-w-[85vw] bg-gradient-to-b from-slate-900/95 via-purple-900/95 to-slate-900/95 backdrop-blur-xl border-r border-white/10 lg:relative lg:w-full lg:max-w-none shadow-2xl">
          ...
          {/* Content */}
          <ScrollArea className="flex-1 p-4 relative z-10 h-[calc(100vh-180px)]">
                        ...
                        {editingId === session.id ? (
                          <div className="space-y-2">
                            ...
                            <div className="flex space-x-1">
                              <Button size="sm" onClick={handleEditSave} className="h-6 bg-gradient-to-r from-purple-500 to-blue-500">
                                <Check className="w-3 h-3" />
                              </Button>
                              <Button size="sm" variant="outline" onClick={handleEditCancel} className="h-6 border-white/20 text-white hover:bg-white/10">
                                <X className="w-3 h-3" />
                              </Button>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <Button
                                ...
                                className="w-5 h-5 p-0 text-white/60 hover:text-white hover:bg-white/20"
                              >
                              ...
                              <Button
                                ...
                                className="w-5 h-5 p-0 text-red-400 hover:text-red-300 hover:bg-red-500/20"
                              >

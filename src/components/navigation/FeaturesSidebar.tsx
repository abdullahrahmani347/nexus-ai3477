  ...
  const features = [
    {
      category: 'Chat & AI',
      items: [
        { name: 'AI Chat', path: '/chat', icon: MessageSquare, description: 'Main chat interface' },
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 lg:relative lg:inset-auto">
        ...
        {/* Sidebar */}
        <div className="fixed left-0 top-0 h-full w-80 max-w-[85vw] bg-slate-900/95 backdrop-blur-xl border-r border-white/10 lg:relative lg:w-full lg:max-w-none">
          {/* Header */}
